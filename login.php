...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
    ...
    <link rel="stylesheet" href="css/login.css" type="text/css"> <!-- Down strng the up -->
    ...
    <div class="pic"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span>تسجيل الدخول</div>    
    ...
    <button class="main wow bounceInUp" type="submit"> دخول</button>
        ...
        <h5 class="lin">ليس لديك حساب ؟<a href="Register.php">  سجل الآن </a>  </h5>
